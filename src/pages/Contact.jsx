                        ...
                        <Row>
                            ...
                            <Col lg='5' md = '5'>
                                    <div className = 'contact__info'>
                                        ...
                                        <p className = 'section__description mb-0'>Bulevardul Unirii 100,Bucuresti,Romania</p>
                                        </div>
                                        
                                        <div className =  '  d-flex align-items-center gap-2'>
                                        
                                            <h6 className = 'fs-6 mb-0'>Phone:</h6>
                                            <p className = 'section__description mb-0'>+040712345678</p>
                                        </div>

                                        <div className =  '  d-flex align-items-center gap-2'>
                                            <h6 className = 'mb-0 fs-6'>Email:</h6>
                                            <p className = 'section__description mb-0'>dealer.auto.bucuresti@gmail.com</p>
                                        </div>
